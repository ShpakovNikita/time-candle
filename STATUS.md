...
- фикс периодических тасок
- сделать все более юзабельным, что ли
- добавить права на модифай и не давать юзерам пытаться сделать то, чего нельзя
- синхронизировать uid django и uid users из time_candle
- сделать чисто просмотр персональных тасок
- сделать поддеревья дочерних тасок
- сделать ранджирование из query
