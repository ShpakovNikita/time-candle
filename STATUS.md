...
- добавить страницу отображения именно тасок специфичного проекта (вместе с этим отобразить доп карту самого проекта с описанием и т д или же сайд вью вместе со списком юзеров в проекте) (\#almost, users remained)
