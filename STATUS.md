...
- добавить инструкции
- наладить сервер в релиз
- добавить просмотр сообщений себе же и их удалений
- добавить сорт по времени в query
- дисэйбл кнопки периодической таски
- сделать карты большие реально красивыми, не зря же я делал разметки ручками
